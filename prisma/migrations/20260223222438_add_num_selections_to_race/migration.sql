...
INSERT INTO "new_races" ("createdAt", "deletedAt", "description", "districtId", "electionId", "id", "name", "raceTypeId", "slug", "status", "updatedAt") SELECT "createdAt", "deletedAt", "description", "districtId", "electionId", "id", "name", "raceTypeId", "slug", "status", "updatedAt" FROM "races";
DROP TABLE "races";
